    ...
    async def _run_streamlit_app(self):
        ...
        try:
            ...
            with st.sidebar:
                ...
                st.metric(
                    "Bot Status",
                    f"{status_color} {'Running' if bot_status['running'] else 'Stopped'}",
                )
            ...
            tab1, tab2, tab3, tab4, tab5 = st.tabs(
                ["📊 Portfolio", "📈 Positions", "🤖 ML Models", "⚠️ Risk", "📋 Logs"]
            )
    ...
    async def _render_logs_tab(self):
        ...
        try:
            ...
            log_level = st.selectbox(
                "Filter by Log Level", ["ALL", "INFO", "WARNING", "ERROR", "CRITICAL"]
            )
            ...
            logs = [
                ...
                },
                {
                    ...
                    "level": "INFO",
                    "message": "Generated BUY signal for BTC/USDT (confidence: 0.85)",
                },
                {
                    "timestamp": "2024-01-15 10:31:10",
                    "level": "SUCCESS",
                    "message": "Executed BUY order for BTC/USDT at $42,150",
                },
                {
                ...
                },
                {
                    ...
                    "level": "INFO",
                    "message": "Risk management check passed",
                },
            ]
