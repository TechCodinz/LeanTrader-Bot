            ...
            try:
                ...
                if symbol in symbol_map:
                    ...
                    response = requests.get(
                        f'https://api.coingecko.com/api/v3/coins/{coin_id}', timeout=10
                    )
        ...
        try:
            ...
            try:
                ...
                for pair in forex_pairs:
                    try:
                        response = requests.get(
                            f'https://query1.finance.yahoo.com/v8/finance/chart/{pair}', timeout=5
                        )
                    ...
                    for coin in data['coins'][:10]:  # Top 10 trending
                        ...
                        try:
                            ...
                            if detail_response.status_code == 200:
                                ...
                                if (
                                    market_cap < 100000000 and price_change_24h > 20
                                ):  # < $100M cap, > 20% growth
                                    moon_token = {
                                        ...
                                        'buy_locations': self.get_buy_locations(
                                            detail_data['symbol'].upper()
                                        ),
                                        'timestamp': datetime.now(),
                                    }
