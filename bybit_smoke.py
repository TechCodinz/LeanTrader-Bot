...
from bybit_adapter import (account_summary_lines, bybit_init, fetch_ohlcv,
                           order_market)
...
def parse_args():
    ...
    p.add_argument(
        "--stake_usd", type=float, default=2.0, help="USD value to use for market order"
    )
