...
def regional_feeds(country: str) -> List[str]:
    ...
    if country in (
        ...
        return REGIONAL_FEEDS["EU"]
    if country in ("JP", "KR", "SG", "HK", "ID", "MY", "TH", "PH", "VN", "IN", "CN"):
        return REGIONAL_FEEDS["ASIA"]
    if country in ("NG", "ZA", "KE", "EG", "MA", "GH", "ET", "TZ", "UG", "DZ"):
...
def preferred_exchanges(country: str) -> List[str]:
    ...
    if c in (
        ...
        return PREFS["EU"]
    if c in ("JP", "KR", "SG", "HK", "ID", "MY", "TH", "PH", "VN", "IN", "CN"):
        return PREFS["ASIA"]
